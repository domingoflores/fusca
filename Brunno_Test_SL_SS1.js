...
function ExecuteRequest(request, response) {
	...
	columns[1] = new nlobjSearchColumn("custentity_acq_deal_zzz_zzz_legal_text");
	columns[2] = new nlobjSearchColumn("custentity_acq_deal_lotach");
	columns[3] = new nlobjSearchColumn("custentity_qx_acq_deal_domesticwire");
	columns[4] = new nlobjSearchColumn("custentity_qx_acq_deal_internationalwire");
	columns[5] = new nlobjSearchColumn("custentity_qx_acq_deal_domesticcheck");
	columns[6] = new nlobjSearchColumn("custentity_qx_acq_deal_internationalchec");
	columns[7] = new nlobjSearchColumn("custentity_acq_deal_lot_send_lots");
	columns[8] = new nlobjSearchColumn("custentity_acq_deal_fx_level");
	columns[9] = new nlobjSearchColumn("custentity_acq_deal_fx_curr_cbox");
