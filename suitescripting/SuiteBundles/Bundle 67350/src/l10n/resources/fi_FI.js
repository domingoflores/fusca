...
define(function() {
    var translation = {
		...
		"apm.cd.label.webservices" : "Verkkopalvelut",
		...
		"apm.ns.client.recalc" : "laske uud.",
		...
		"apm.ptd.label.scriptaftersubmit" : "Koodi: aftersubmit: {0}",
		"apm.ptd.label.scriptbeforeload" : "Koodi: beforeload: {0}",
		"apm.ptd.label.scriptbeforesubmit" : "Koodi: beforesubmit: {0}",
		"apm.ptd.label.scriptpageinit" : "Koodi: pageinit:” {0}",
		...
		"apm.ptd.label.userevent" : "KÄYTTÄJÄTAPAHTUMA",
		...
		"apm.scpm.alert.startdate30dayscurrentdate" : "Aloituspäivämäärä ei saa ylittää 30:tä päivää nykyisestä päivämäärästä",
		...
		"apm.setup.label.setuppermissionlabel" : "Aseta lupa sovelluksen suorituskyvyn hallinnoinnin SuiteApp-ohjelmalle",
		...
		"apm.common.label.performance" : "Suorituskyky",

    	//NEW
        "apm.r2019a.profilerdetails": "Profiloijan tiedot",
        "apm.r2019a.viewprofilerdetails": "Tarkastele profiloijan tietoja",
        ...
        "apm.r2019a.scispermissions": "Määritä roolien SuiteCommerce InStore APM SuiteApp -luvat.",
