 ...
 * source: https://stackoverflow.com/questions/286921/efficiently-replace-all-accented-characters-in-a-string/18160397#18160397
 * This method removes any characters with diacritic marks (e.g. accent marks, umlauts, carats, etc.) and replaces them with their
 * most intuitive basic character(s).
 * Added oe and OE and thorn characters
 * See bottom for character map
 * 
 */	
...
define([],
	function() {
		...
		function replaceWindowsCharacters(str) {
		    var defaultWindowsCharsRemovalMap = [
		        {'base': ',', 'letters':/[\u201A]/g},
		        {'base': '\'', 'letters':/[\u2018\u2019]/g},
		        {'base': '"', 'letters':/[\u201C\u201D]/g},
		        {'base': '-', 'letters':/[\u2013\u2014]/g},
		  ...
		  for(var i=0; i<defaultWindowsCharsRemovalMap.length; i++) {
		    str = str.replace(defaultWindowsCharsRemovalMap[i].letters, defaultWindowsCharsRemovalMap[i].base);
		  }
		...
		function removeSpecialCharacters(str) {
			...
			return replaceWindowsCharacters(str);
		}
