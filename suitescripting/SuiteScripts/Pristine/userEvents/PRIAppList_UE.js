...
function(redirect, runtime, tools, priMessage) {
	 ...
	 var scriptFileName = "PRIAppList_UE.js";
     	...
     	if (runtime.executionContext == runtime.ContextType.USER_INTERFACE)
     	{
	     	...
	     	if (context.type == context.UserEventType.CREATE || context.type == context.UserEventType.EDIT) 
	     	{
	     		...
	     		{ 	
	     			...
	     			priMessage.prepareMessage("PERMISSION DENIED", "You do not have permissions to access the PRI App List. Please contact your NetSuite administration if this is an error.", priMessage.TYPE.ERROR);
	     			var parameters = {};
	     			redirect.toRecord({ type:"customrecord_pri_app_list" ,id:context.newRecord.id ,parameters:parameters }); 
	     		}
	     	}
     	}
     	else if (runtime.executionContext == runtime.ContextType.CSV_IMPORT)
     	{
     		throw ("You do not have permissions to access the PRI App List. Please contact your NetSuite administration if this is an error.");
 		}
     }
