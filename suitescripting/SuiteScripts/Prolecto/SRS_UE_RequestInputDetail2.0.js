...
function(runtime, tools) {
    ...
    function beforeLoad(context) 
    {
		...
		if (!hasAccess) { 	throw 'PERMISSION_DENIED: You do not have permissions to access CRE Request Input Header. Please contact your NetSuite administration if you believe this is in error.'; }		
