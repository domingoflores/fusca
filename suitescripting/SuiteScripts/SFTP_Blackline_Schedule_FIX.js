...
define(['N/record', 'N/search', 'N/file', 'N/runtime', '/SuiteScripts/Pristine/libraries/searchLibrary', '/SuiteScripts/Pristine/libraries/sftpLibrary'],
	function(record, search, file, runtime, searchLibrary, SFTPLibrary) {
		...
		function execute(context) {
			...
			log.debug({
				title: 'ROLE IS..',
				details: runtime.getCurrentUser().role
			});
			...
			if (runtime.envType == 'SANDBOX'){
				...
				var savedSearchIDArray = ['customsearch16795'];	// 'customsearch16510', 'customsearch15551', 'customsearch16621', 'customsearch16077', 'customsearch16671'
			}
			...
			for (var ss = 0; ss < savedSearchIDArray.length; ss++){
				...
				if(savedSearchIDArray[ss] == 'customsearch16510'){
					...
					fileType = file.Type.PLAINTEXT;	
					includeHeader = 0;
				}else if(savedSearchIDArray[ss] == 'customsearch16795'){
				...
				var sftpServerCreds = {
					...
					passwordGuid: '08afaba7f6b64d04b55dba1df1a685f4',
