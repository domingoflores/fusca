...
//	var form = nlapiCreateForm('Open Releases Dashboard');  //Setup the selection form
	...
	var excla = sublist.addField('custpage_excalated','checkbox',"<a href='#' style=color:#3399FF title='Excalated to Compliance'>"+"!"+"</a>")
	excla.setDisplaySize(1)
...
//	sublist.addField('custpage_nextduedate','textarea','Expire');
	sublist.addField('custpage_expire','date','Expire').setDisplayType('entry'); //STS ADDED 
	sublist.addField('custpage_releasetowho','text','To');
	sublist.addField('custpage_releaseamount','text','$').setDisplayType('entry');
	...
	var eapa = sublist.addField('custpage_releasecontact','select',"<a href='#' style=color:#339933 title='Release Contact (EA/PA)'>"+"EA/PA"+"</a>")
	var ee1  = sublist.addField('custpage_releaseexpensefundsdue','select',"<a href='#' style=color:#339933 title='Escrow Exchange (EE)'>"+"EE"+"</a>")
	var exp  = sublist.addField('custpage_release','select',"<a href='#' style=color:#339933 title='Expense Fund Location and Being Released (EXP$)'>"+"EXP$"+"</a>")
	var sch  = sublist.addField('custpage_releasescheduled','select',"<a href='#' style=color:#339933 title='Release Schedule (SCH)'>"+"SCH"+"</a>")
	var pm   = sublist.addField('custpage_releasepayoutmechanics','select',"<a href='#' style=color:#339933 title='Release Payout Mechanics (PM)'>"+"PM"+"</a>")
	var v1   = sublist.addField('custpage_releasemoveverified','select',"<a href='#' style=color:#339933 title='Funds / Shares Distributed (VER)'>"+"VER"+"</a>")
	var all  = sublist.addField('custpage_releaseallocated','select',"<a href='#' style=color:#339933 title='Booked, Allocated, Released, Negative Shareholder? (ALL)'>"+"ALL"+"</a>")
	var ql   = sublist.addField('custpage_releasequietletter','select',"<a href='#' style=color:#3399FF style=color:#3399FF title='Release Quiet Letter (QL)'>"+"QL"+"</a>")
	var el   = sublist.addField('custpage_releaseexpirationletter','select',"<a href='#' style=color:#3399FF title='Release Expiration Letter (EL)'>"+"EL"+"</a>")
	var il   = sublist.addField('custpage_releaseinstructionletter','select',"<a href='#' style=color:#3399FF title='Release Instruction Letter (IL)'>"+"IL"+"</a>")
	var sl1  = sublist.addField('custpage_releaseshareholderletter','select',"<a href='#' style=color:#3399FF title='Release Shareholder Letter (SL)'>"+"SL"+"</a>")
	var lgl  = sublist.addField('custpage_releaselegalapproval','select',"<a href='#' style=color:#3399FF title='Legal Approval (LA)'>"+"LA"+"</a>")
//	var rp   = sublist.addField('custpage_releasetoportal','select',"<a href='#' style=color:#3399FF title='Release to Portal (RP)'>"+"RP"+"</a>")
	var esn  = sublist.addField('custpage_releaseescrowstatementnews','select',"<a href='#' style=color:#3399FF title='Release Escrow Statement News (ESN)'>"+"ESN"+"</a>")

	exp.addSelectOption('1','B'); exp.addSelectOption('3','S'); exp.addSelectOption('2', 'N'); exp.addSelectOption('', '-');
	ee1.addSelectOption('1','-'); ee1.addSelectOption('3','Y'); ee1.addSelectOption('2', 'N');
	...
	eapa.addSelectOption('1','AST'); eapa.addSelectOption('2','BNY'); eapa.addSelectOption('3', 'Buy'); eapa.addSelectOption('4','Cap1'); eapa.addSelectOption('5', 'Citi');
	eapa.addSelectOption('6','COM'); eapa.addSelectOption('7','CS');  eapa.addSelectOption('8', 'CST'); eapa.addSelectOption('9','DB');  eapa.addSelectOption('10', 'ESOP');
	eapa.addSelectOption('11','JPM'); eapa.addSelectOption('12','SGS'); eapa.addSelectOption('13', 'Sun'); eapa.addSelectOption('14','SVB'); eapa.addSelectOption('15', 'Union');
	eapa.addSelectOption('16','USB'); eapa.addSelectOption('17','Wilm'); eapa.addSelectOption('18', 'WF'); eapa.addSelectOption('19','Other'); eapa.addSelectOption('','-');
	...
	ql.addSelectOption('1','D'); ql.addSelectOption('3','S'); ql.addSelectOption('2', 'N/A'); ql.addSelectOption('', '-');
	el.addSelectOption('1','D'); el.addSelectOption('3','S'); el.addSelectOption('2', 'N/A'); el.addSelectOption('', '-');
	il.addSelectOption('1','Auto'); il.addSelectOption('2','D'); il.addSelectOption('3', 'A'); il.addSelectOption('4', 'S'); il.addSelectOption('5', 'N/A'); il.addSelectOption('', '-');
	sl1.addSelectOption('1','D'); sl1.addSelectOption('3','S'); sl1.addSelectOption('2', 'N/A'); sl1.addSelectOption('', '-');
...
//	rp.addSelectOption('1','-'); rp.addSelectOption('3','Y'); rp.addSelectOption('2', 'N');
	esn.addSelectOption('1','-'); esn.addSelectOption('3','Y'); esn.addSelectOption('2', 'N');
