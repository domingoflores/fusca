...
//	sublist.addField('custpage_nextduedate','textarea','Expire');
	...
	var eapa1 = sublist.addField('custpage_releasecontact','select',"<a href='#' style=color:#339933 title='Release Contact (EA)'>"+"EA"+"</a>").setDisplayType(distype)
...
//	var rp   = sublist.addField('custpage_releasetoportal','select',"<a href='#' style=color:#3399FF title='Release to Portal (RP)'>"+"RP"+"</a>").setDisplayType(distype);
	...
	eapa1.addSelectOption('1','AST'); eapa1.addSelectOption('2','BNY'); eapa1.addSelectOption('3', 'Buy'); eapa1.addSelectOption('4','Cap1'); eapa1.addSelectOption('5', 'Citi');
	eapa1.addSelectOption('6','COM'); eapa1.addSelectOption('7','CS');  eapa1.addSelectOption('8', 'CST'); eapa1.addSelectOption('9','DB');  eapa1.addSelectOption('10', 'ESOP');
	eapa1.addSelectOption('11','JPM'); eapa1.addSelectOption('12','SGS'); eapa1.addSelectOption('13', 'Sun'); eapa1.addSelectOption('14','SVB'); eapa1.addSelectOption('15', 'Union');
	eapa1.addSelectOption('16','USB'); eapa1.addSelectOption('17','Wilm'); eapa1.addSelectOption('18', 'WF'); eapa1.addSelectOption('19','Other'); eapa1.addSelectOption('','-');
	eapa2.addSelectOption('1','AST'); eapa2.addSelectOption('2','BNY'); eapa2.addSelectOption('3', 'Buy'); eapa2.addSelectOption('4','Cap1'); eapa2.addSelectOption('5', 'Citi');
	eapa2.addSelectOption('6','COM'); eapa2.addSelectOption('7','CS');  eapa2.addSelectOption('8', 'CST'); eapa2.addSelectOption('9','DB');  eapa2.addSelectOption('10', 'ESOP');
	eapa2.addSelectOption('11','JPM'); eapa2.addSelectOption('12','SGS'); eapa2.addSelectOption('13', 'Sun'); eapa2.addSelectOption('14','SVB'); eapa2.addSelectOption('15', 'Union');
	eapa2.addSelectOption('16','USB'); eapa2.addSelectOption('17','Wilm'); eapa2.addSelectOption('18', 'WF'); eapa2.addSelectOption('19','Other'); eapa2.addSelectOption('','-');
