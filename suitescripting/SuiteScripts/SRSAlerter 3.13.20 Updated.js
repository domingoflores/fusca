...
var docket_search_alerts = [
    ...
    ,['transaction','customsearch18404','ACQUIOM ANALYSTS - Inactive Acquiom GL Account with a balance',18404]
  	...
  	,['transaction','customsearch19326','ACQUIOM ANALYSTS - Payments Alert - Refunds for Check Paid Date Updates',19326]
	...
	,['customrecord_acq_lot','customsearch19462','ACQUIOM ANALYSTS - Unpaid Exchange Records with Alpha PI record',19462]
	,['customrecord_acq_lot','customsearch20451','ACQUIOM ANALYSTS - ALERT - ER not tied to DER',20451]
	...
	,['customrecord_acq_lot','customsearch18895','ACQUIOM ANALYSTS - ALERT - Shareholder or Deal Does Not Match LOT CERT vs ER',18895]
	,['customrecord_acq_lot_cert_entry','customsearch10660','ACQUIOM ANALYSTS - ALERT - Inactive Certificates with $ amount',10660]
	,['transaction','customsearch19178','ACQUIOM ANALYSTS - Funds Received - KYC Not Approved on deal page',19178]
	,['customrecord_acq_lot','customsearch19629','ACQUIOM ANALYSTS - Invalid ABA on ER',19629]
	,['supportcase','customsearch20480','ACQUIOM ANALYSTS - Deposit Case Created No Timestamp Populated',20480]
	,['customrecord_fx_conv_contract','customsearch20237','ACQUIOM ANALYSTS - FX Contract Approved - No Email Confirmation File Attached',20237]
	,['customrecord_acq_lot','customsearch20047','PAYMENTS SUPPORT - Audience Missing on Deal Dashboard Doc',20047]
	,['customrecord_document_management','customsearch17731','PAYMENTS SUPPORT - 6 months old - Records by Box - Physical Docs',17731]
	,['customrecord_document_management','customsearch20815','PAYMENTS SUPPORT - Deal Dashboard SH Doc With No File OR Backup Link',20815]
	,['customrecord_acq_lot','customsearch15072','PAYMENTS SUPPORT - Document Ready for Dual Entry no File Attached',15072]
	,['customrecord_acq_lot','customsearch19099','AES OPS: Location Codes Missing',19099]
	,['customrecord_acq_lot','customsearch20569','AES OPS: Returned & Voided Payments',20569]
	,['customrecord_acq_lot','customsearch17223','TAX OPS: Payments Held',17223]
	,['customrecord_acq_lot','customsearch20810','TAX OPS: NGP Payments Made To W-8IMYs',20810]
	,['customrecord_acq_lot','customsearch15521','TAX OPS: Certs Pending Tax Instruction',15521]
	,['customrecord_acq_lot','customsearch20808','TAX OPS: Certs Pending & Deal Review Complete',20808]
	,['customrecord_acq_lot_cert_entry','customsearch15615','TAX OPS: Certs Reviewed Box # Empty',15615]
	,['customrecord_acq_lot','customsearch5038','TAX OPS: Cert Fields Incomplete',5038]
	,['customrecord_acq_lot','customsearch15608','TAX OPS: Paid W-8 Missing Validation',15608]
	,['customrecord_acq_lot','customsearch18559','TAX OPS: W9 For Possible Foreign Holders',18559]
	...
	,['transaction','customsearch20459','IMPORTS - Actian Investment Earnings Escrow Transactions Check',20459]
	...
	,['customrecord_import_record','customsearch17555','IMPORTS Import Records without Document',17555]
...
var ra_search_alerts = [
	...
	,['customer','customsearch19201','Deal Closed - Missing Agreements - Escrow and Payments Deals',19201]
	,['transaction','customsearch18341','Transactions Posted - First Day Funding not Complete',18341]
	,['transaction','customsearch18947','Alert - AEA Transaction, Product not Selected',18947]
	,['customer','customsearch18845','Acquiom Deal Closed - No Acquiom Invoice',18845]
	,['customrecord_escrow_agent_disbursement','customsearch20066','AEA Disbursements No Transactions',20066]
	,['customer','customsearch18847',' PHYSICAL DOCUMENTS REQUIRED FOR PAYMENT Empty',18847]
	,['customrecord_document_management','customsearch20678','ALERT - Deal Document Missing Audience (On or After 2/19/2020)',20678]
	,['customer','customsearch20606','Closed AEA or PA Deal Not Sent to Docket',20606]
...
function runDetail(report, subject)
{
 ...
 function buildReports(searchAlerts)
 {
	...
	for (var i = 0; i < searchAlerts.length; i++) // loop over docket based reports
	{
        ...
        //ATP-1286 hotfix for URL
        completeURL = completeURL.replace("ext772390-sb1.", "").replace("ext772390-sb3.", "").replace("ext772390.", "").replace("extsystem", "app");
