...
{	// likely this is only called once
	portlet.setTitle('Important Dates');

	var portletUrl = nlapiResolveURL('SUITELET','customscript_event_action_handler','customdeploy_event_action_handler','FALSE');
...
function renderEventList(portletRequest)
{
	...
	var handler = nlapiResolveURL('SUITELET','customscript_event_action_handler','customdeploy_event_action_handler','FALSE');
	...
	nlapiLogExecution('DEBUG', "Event List DUMP", eventList);
