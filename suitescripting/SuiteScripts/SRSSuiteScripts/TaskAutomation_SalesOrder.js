...
function onBeforeLoad(type, form)
{
    ...
    {   
		...
		nlapiLogExecution("DEBUG", "TaskAutomation_SalesOrder.onBeforeLoad", "entityId =" + entityId);

        addTaskSublistTab('items',entityId,'company');
    }
}
...
function onAfterSubmit(type, form)
{
    if (type != "delete")
    {
