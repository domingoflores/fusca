...
//	imagehtml += "<a href="+imageurl+" style=color:#0000FF>"+imagename+"</a>"
		...
		nlapiLogExecution('ERROR', 'document image problem', '');
		response.writePage('Problem loading the doc image field \'custrecord_acq_loth_zzz_zzz_rcvddocimage\' from the Exchange Record');
	}
