...
Util.isFedEX = function(trackingNumber){ //Boolean
	...
	if (trackingNumber.length === 12) {
		//Util.log('trackingNumber.length = '+trackingNumber.length );
		...
		//Util.log('FedEx Express Shipment Algorithm Total = ' + trackTotal + ", Remainder = " + chkDigit,trackingNumber.charAt(11) * 1);
		if (chkDigit === 10) 
			chkDigit = 0;
...
Util.makeTrackingLink = function(trackingNumber){ //String
	...
	if(Util.isFedEX(trackingNumber))
